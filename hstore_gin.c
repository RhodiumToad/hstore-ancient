...
gin_consistent_hstore(PG_FUNCTION_ARGS)
{
	...
	else if (strategy == HStoreExistsAllStrategyNumber)
	{
		...
		/* we have to do a full-on deconstruct here for no reason other
		 * than silly deficiencies of the GIN interface; we have no other
		 * way to get the count of entries in the "check" array. Yuk!
		 * (we can't just use the array size, since we dropped out any
		 * null values)
		 */
